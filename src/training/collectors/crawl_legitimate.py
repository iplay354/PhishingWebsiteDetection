...
def fetch_html(url, outpath_crawl, timeout=3):                                                                            #outpath: nơi lưu file html, timeout: thời gian chờ yêu cầu     #tải html từ url
    headers = {
...
def main(csv_in=None, path_save_html=None, delay=0.1):                                                                         #hàm chính
    csv_in = csv_in or os.path.join(ROOT, "data", "raw", "legiti.csv")
    path_save_html = path_save_html or os.path.join(ROOT, "data", "crawled_html", "legitimate1")
